        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-6 col-lg-5">
                <div class="card mv-card">
                    ...
                    <p class="section-text">
                        To provide world-class diagnostic and rehabilitative services for individuals with speech and hearing challenges. We strive to empower our patients through personalized care, advanced technology, and compassionate support to improve their quality of life and communication.
                    </p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-5">
                <div class="card mv-card">
                    ...
                    <p class="section-text">
                        To be a leader in speech and hearing healthcare, creating a world where every individual has the opportunity to communicate effectively and live a life without barriers.
                    </p>
                </div>
            </div>
